...
int main()
{
    ...
    //cara, isso aqui foi absurdamente inteligente, cada pilha so vai armazenar botas de um pe, que vai ser justamente o primeiro lado que aparecer
    celula *botas[32];
    ...
    {
        //ainda nao tinha nenhum par daquela numeração na pilha correspondente
